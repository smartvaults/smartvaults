...
```bash
./target/release/smartvaults-cli generate lee
```

## Get policies
```bash
./target/release/smartvaults-cli get policies lee
```
...
## Get policy
```
./target/release/smartvaults-cli --network testnet get policy lee 4f13ae0ce31cd256a4b3b84ddc0c76c2399e8bbd3e9659b6bb81e83f88fbea82
```
...
```bash
./target/release/smartvaults-cli inspect lee
```
