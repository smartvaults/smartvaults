...
// Default relays
pub const MAINNET_RELAYS: [&str; 2] = ["wss://relay-prod1.hashed.systems", "wss://relay-prod2.hashed.systems"];
pub const TESTNET_RELAYS: [&str; 2] = ["wss://relay-test1.hashed.systems", "wss://relay-test2.hashed.systems"];
