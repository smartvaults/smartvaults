...
pub static SMARTVAULTS_MAINNET_PUBLIC_KEY: Lazy<PublicKey> = Lazy::new(|| {
    PublicKey::from_str("32c961f39afcff6df6abed251b346550329b2dbcabca0667530f0be5054fe7ae")
        .expect("Invalid public key") // npub1xtykruu6lnlkma4ta5j3kdr92qefktdu409qve6npu972p20u7hqhh99km
});
pub static SMARTVAULTS_TESTNET_PUBLIC_KEY: Lazy<PublicKey> = Lazy::new(|| {
    PublicKey::from_str("2c2dcda12330dda3b9600237a419003c5d9bf3d757303e63ecee121b4aaa2fa0")
